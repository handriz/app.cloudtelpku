<div class="p-6 bg-white dark:bg-gray-800 rounded-lg h-full flex flex-col">
    ...
    <div class="flex justify-between items-center mb-2 pb-2 border-b border-gray-200 dark:border-gray-700">
        ...
        <button onclick="App.Tabs.closeTab('Rute [{{ $areaCode }}]')"
            ...
            <i class="fas fa-times mr-2"></i> BACK
        </button>
    </div>
    ...
    <div class="mb-5 bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800 rounded-lg p-3">
        <div class="flex items-start gap-3">
            ...
            <div class="flex-1">
                <h4 class="text-xs font-bold text-blue-800 dark:text-blue-300 uppercase mb-2">Panduan Struktur Kode RPP
                    dan RBM (12 Digit)</h4>
                ...
                <div class="flex flex-wrap items-center text-center text-[10px] font-mono gap-1">
                    ...
                    <div class="flex flex-col opacity-50">
                        <div class="flex gap-0.5">
                            <span
                                class="bg-gray-200 dark:bg-gray-700 px-1.5 py-1 rounded-l border border-gray-500">Digit
                                1</span>
                            <span
                                class="bg-gray-200 dark:bg-gray-700 px-1.5 py-1 border-t border-b border-gray-500">Digit
                                2</span>
                            <span
                                class="bg-gray-200 dark:bg-gray-700 px-1.5 py-1 rounded-r border border-gray-500">Digit
                                3</span>
                        </div>
                    ...
                    <div class="flex flex-col">
                        <div class="flex gap-0.5">
                            <span
                                class="bg-indigo-100 dark:bg-indigo-900 text-indigo-700 dark:text-indigo-300 font-bold px-1.5 py-1 rounded-l border border-indigo-200">Digit
                                4</span>
                            <span
                                class="bg-indigo-100 dark:bg-indigo-900 text-indigo-700 dark:text-indigo-300 font-bold px-1.5 py-1 rounded-r border border-indigo-200">Digit
                                5</span>
                        </div>
                    ...
                    <div class="flex flex-col relative group cursor-help">
                        <div class="flex gap-0.5">
                            ...
                            <div class="flex flex-col">
                                <span
                                    class="bg-green-100 dark:bg-green-900 text-green-700 dark:text-green-300 font-bold px-1.5 py-1 rounded-l border border-green-200 ring-2 ring-green-400 ring-offset-1">
                                    Digit 6
                                </span>
                            </div>
                            ...
                            <div class="flex flex-col">
                                <span
                                    class="bg-green-100 dark:bg-green-900 text-green-700 dark:text-green-300 font-bold px-1.5 py-1 rounded-r border border-green-200 ring-2 ring-green-400 ring-offset-1">
                                    Digit 7
                                </span>
                            </div>
                        </div>
                        ...
                        {{-- Tooltip Penjelasan --}}
                        <div
                            class="absolute bottom-full mb-2 left-1/2 transform -translate-x-1/2 w-56 bg-gray-800 text-white text-[9px] p-2 rounded hidden group-hover:block z-50 text-left shadow-lg leading-relaxed">
                    ...
                    <div class="flex flex-col opacity-50">
                        <div class="flex gap-0.5">
                            <span
                                class="bg-gray-200 dark:bg-gray-700 px-1.5 py-1 rounded-l border border-gray-500">NO.URUT</span>
                        </div>
    ...
    <div
        ...
        <div class="relative flex-1 w-full">
            ...
            <input type="text" id="route-search-input" onkeyup="window.settingsHandler.filterRoutesTable()"
        ...
        <div class="flex gap-2 items-center w-full md:w-auto">
            <div class="flex flex-col">
                ...
                <input type="text" id="new-route-code" placeholder="AA" maxlength="2" autocomplete="OFF"
            ...
            <div class="flex flex-col flex-1 md:w-64">
                <label class="text-[9px] font-bold text-gray-800 uppercase">Keterangan / Nama Petugas</label>
            ...
            <table class="w-full text-sm text-left table-fixed">
                <thead
                    ...
                    <tr>
                        ...
                        <th
                            class="text-center w-[70px] py-2 border-r dark:border-gray-600 bg-green-50 dark:bg-green-900/20">
                            KELOMPOK <span class="text-[9px] text-green-600 block normal-case"
                                title="Digit 6 (Petugas)">Digit 6</span>
                        </th>
                        <th
                            class="text-center w-[70px] py-2 border-r dark:border-gray-600 bg-green-50 dark:bg-green-900/20">
                            HARI <span class="text-[9px] text-green-600 block normal-case"
                                title="Digit 7 (Kode Hari)">Digit 7</span>
                        </th>
                    ...
                    <tbody class="border-b border-gray-200 dark:border-gray-700">
                        ...
                        @foreach ($items as $route)
                            ...
                            <tr class="hover:bg-indigo-50 dark:hover:bg-gray-700 transition-colors route-row-item"
                                ...
                                {{-- DIGIT 6: KELOMPOK --}}
                                <td
                                    class="text-center font-bold text-gray-800 dark:text-gray-200 border-r dark:border-gray-700 py-1 align-middle bg-green-50/30 dark:bg-green-900/10">
                                    {{ substr($code, 0, 1) }}
                                </td>
                                    ...
                                    <div class="flex flex-col justify-center h-full">
                                        ...
                                        @if ($hasData)
                                            <div class="mt-1.5 w-full">
                                                <div class="flex justify-between items-end mb-0.5">
                                                    <div
                                                        ...
                                                        <span
                                                            class="font-bold text-indigo-700 dark:text-indigo-300">{{ number_format($count) }}</span>
                                                        <span class="text-[9px] opacity-70">Plg</span>
                                                    </div>
                                                    <span class="text-[9px] text-gray-400">{{ round($percent) }}%
                                                        Beban</span>
                                                </div>
                                                <div
                                                    class="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-1.5 overflow-hidden">
                                            ...
                                            @if (str_contains($route['label'], '⚠️'))
                                                <div
                                                    class="mt-1 text-[9px] text-red-500 font-bold bg-red-50 px-1 rounded inline-block">
                                                    <i class="fas fa-exclamation-circle"></i> Cek Unit
                                                </div>
                                            @endif
                                        @else
                                            <div class="mt-1 text-[10px] text-gray-400 italic opacity-60">Belum ada
                                                pelanggan</div>
                                        @endif
                                    </div>
                                </td>
                                ...
                                <td class="text-center py-1 align-middle">
                                    @if ($hasData)
                                        <i class="fas fa-lock text-gray-300 text-xs cursor-not-allowed"
                                            title="Terkunci"></i>
                                    @else
                                        <button type="button"
