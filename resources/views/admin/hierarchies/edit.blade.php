    ...
    <div class="pt-0 pb-0">
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                <form method="POST" action="{{ route('admin.hierarchies.update', $hierarchy) }}">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="code" id="code" value="{{ old('code', $hierarchy->code) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name', $hierarchy->name) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <select name="parent_code" id="parent_code"
                            ...
                            @renderHierarchyParentOptions($parentHierarchyLevels, null, 0, old('parent_code', $hierarchy->parent_code), $hierarchy->code)
                        </select>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="order" id="order" value="{{ old('order', $hierarchy->order) }}"
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200" required>
